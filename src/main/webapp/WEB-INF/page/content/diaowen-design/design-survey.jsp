...
<head>
    ...
    <title>问卷编辑</title>
    <link href="${ctx }/js/plugs/jquery-ui-1.10.3.custom/css/mycss/jquery-ui-1.10.3.custom.css" rel="stylesheet"
          type="text/css"/>
    ...
    <script type="text/javascript" charset="utf-8"
            src="${ctx }/js/plugs/ueditor1_4_2-utf8-jsp/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8"
            src="${ctx }/js/plugs/ueditor1_4_2-utf8-jsp/ueditor.all.min.js"></script>
    <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
    <script type="text/javascript" charset="utf-8"
            src="${ctx }/js/plugs/ueditor1_4_2-utf8-jsp/lang/zh-cn/zh-cn.js"></script>
    ...
    <!--[if lt IE 7]>
    <link rel="stylesheet" href="ie-stuff.css" type="text/css" media="screen"/><![endif]-->
    <script type="text/javascript">
    </script>
</head>
<body>
                                                        ...
                                                        <ul>
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">选项1</label>
                                                                <div class="quItemInputCase">
                                                                    ...
                                                                    <input type="hidden" name="isRequiredFill"
                                                                           value="0">
                                                                </div>
                                                            </li>
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">选项2</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                ...
                                                <div class="surveyQuItemContent">
                                                    ...
                                                    <div class="quCoItem">
                                                        <ul>
                                                            ...
                                                            <li class="quCoItemUlLi">
                                                                <input type="checkbox"><label
                                                                    class="editAble quCoOptionEdit">选项3</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                        ...
                                                        <ul>
                                                            <li class="quCoItemUlLi">
                                                                ...
                                                                <div class="quFillblankItem">
                                                                    <input type="text" style="width:200px;padding:5px;"
                                                                           class="quFillblankAnswerInput"/>
                                                                    <textarea rows="5"
                                                                              style="width:300px;display: none;"
                                                                              class="quFillblankAnswerTextarea"></textarea>
                                                        ...
                                                        <table class="mFillblankTable">
                                                            <tr class="mFillblankTableTr">
                                                                <td align="right" class="mFillblankTableEditTd"><label
                                                                        class="editAble quCoOptionEdit">选项1</label>
                                                                    <div class="quItemInputCase"><input type="hidden"
                                                                                                        name="quItemId"
                                                                                                        value=""><input
                                                                            type="hidden" name="quItemSaveTag"
                                                                            value="0"></div>
                                                                </td>
                                                                <td><input type="text" style="width:200px;padding:5px;">
                                                                </td>
                                                            </tr>
                                                            <tr class="mFillblankTableTr">
                                                                <td align="right" class="mFillblankTableEditTd"><label
                                                    ...
                                                    <div class="quCoItem">
                                                        ...
                                                        <div class="quOrderByRight">
                                                            <table class="quOrderByTable">
                                                                ...
                                                                <tr>
                                                                    <td class="quOrderyTableTd">2</td>
                                                                    <td></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="quOrderyTableTd">3</td>
                                                                    <td></td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                ...
                                                <div class="surveyQuItemContent">
                                                    ...
                                                    <div class="quCoItem">
                                                        <ul class="transverse">
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">男</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                            ...
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">女</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                ...
                                                <div class="surveyQuItemContent">
                                                    ...
                                                    <div class="quCoItem">
                                                        <ul class="transverse">
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">博士</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                            ...
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">硕士</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                            ...
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">本科</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                            ...
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">专科</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                ...
                                                <div class="surveyQuItemContent">
                                                    ...
                                                    <div class="quCoItem">
                                                        <ul class="transverse">
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">是</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                            ...
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">否</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                ...
                                                <div class="surveyQuItemContent">
                                                    ...
                                                    <div class="quCoItem">
                                                        <ul class="transverse">
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">3000元以下</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                            ...
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">3000-5000元</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                            ...
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">5000-10000元</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                            ...
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">10000-20000元</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                                            ...
                                                            <li class="quCoItemUlLi">
                                                                <input type="radio"><label
                                                                    class="editAble quCoOptionEdit">20000元以上</label>
                                                                <div class="quItemInputCase">
                                                                    <input type="hidden" name="quItemId" value="">
                                                                    <input type="hidden" name="quItemSaveTag" value="0">
                                                                    <input type="hidden" name="isNote" value="0">
                                            ...
                                            <div class="surveyQuItem">
                                                ...
                                                <div class="surveyQuItemContent" style="min-height: 45px;">
                                                    <div class="quCoTitle">
                                                        ...
                                                        <div class="editAble quCoTitleEdit"><p><strong>分段标记</strong></p>
                                                        </div>
                                                        <input type="hidden" name="quTitleSaveTag" value="0">
                                                    </div>
                                                </div>
                                ...
                                <c:when test="${en.quType eq 'RADIO' }">
                                    <div class="surveyQuItemBody">
                                        ...
                                        <div class="quInputCase" style="display: none;">
                                            ...
                                            <div class="quLogicInputCase">
                                                <input type="hidden" name="quLogicItemNum"
                                                       value="${fn:length(en.questionLogics) }">
                                                <c:forEach items="${en.questionLogics }" var="quLogicEn"
                                                    ...
                                                    <div class="quLogicItem quLogicItem_${logicSts.count }">
                                                        ...
                                                        <input type="hidden" name="cgQuItemId"
                                                               value="${quLogicEn.cgQuItemId }"/>
                                                        <input type="hidden" name="skQuId"
                                                        ...
                                                        <input type="hidden" name="scoreNum"
                                                               value="${quLogicEn.scoreNum }">
                                                        <input type="hidden" name="logicType"
                                        ...
                                        <div class="surveyQuItem">
                                            <div class="surveyQuItemLeftTools">
                                                <ul class="surveyQuItemLeftToolsUl">
                                                    ...
                                                    <li title="逻辑" class="dwQuLogic">
                                                        <div class="dwQuIcon">
                                                            <div class="quLogicInfo">${fn:length(en.questionLogics) > 0?fn:length(en.questionLogics) :'' }</div>
                                                        </div>
                                                    </li>
                                                    <li title="删除" class="dwQuDelete">
                                                        <div class="dwQuIcon"></div>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${en.hv eq 3 }">
                                                            <table class='tableQuColItem'>
                                                                <c:forEach begin="0" end="${fn:length(en.quRadios)-1 }"
                                                                           var="j" step="${en.cellCount }">
                                                                    <tr>
                                                                        <c:forEach begin="1" end="${en.cellCount }"
                                                                                   var="k">
                                                                            <td width="${600/en.cellCount }">
                                                                                <!-- 判断不为空，访止数组越界 -->
                                                                                <c:set var="quOptionIndex"
                                                                                       value="${(j+k-1) }"></c:set>
                                                                                <c:choose>
                                                                                    <c:when test="${quOptionIndex < fn:length(en.quRadios) }">
                                                                                        <input type="radio"><label
                                                                                            style="width:${600/en.cellCount-10 }px;"
                                                                                            class="editAble quCoOptionEdit">${en.quRadios[quOptionIndex].optionName }</label>
                                                                                        <input type='text'
                                                                                               class='optionInpText'
                                                                                               style="${item.isNote eq 1 ? '':'display: none;'}"/>
                                                                                        <div class="quItemInputCase">
                                                                                            <input type="hidden"
                                                                                                   name="quItemId"
                                                                                                   value="${en.quRadios[quOptionIndex].id }"><input
                                                                                                type="hidden"
                                                                                                name="quItemSaveTag"
                                                                                                value="1">
                                                                                            <input type="hidden"
                                                            ...
                                                            <ul class="transverse">
                                                                <c:forEach items="${en.quRadios }" var="item">
                                                                    <li class="quCoItemUlLi">
                                                                        ...
                                                                        <input type='text' class='optionInpText'
                                                                               style="${item.isNote eq 1 ? '':'display: none;'}"/>
                                                                        <div class="quItemInputCase">
                                                                            <input type="hidden" name="quItemId"
                                                                                   value="${item.id }"><input
                                                                                type="hidden" name="quItemSaveTag"
                                                                                value="1">
                                                                            <input type="hidden" name="isNote"
                                                                                   value="${item.isNote }">
                                                                            ...
                                                                            <td width="${600/en.cellCount }">
                                                                                ...
                                                                                <c:choose>
                                                                                    <c:when test="${quOptionIndex < fn:length(en.quCheckboxs) }">
                                                                                        <input type="checkbox"><label
                                                                                            style="width:${600/en.cellCount-10 }px;"
                                                                                            class="editAble quCoOptionEdit">${en.quCheckboxs[quOptionIndex].optionName }</label>
                                                                                        <input type='text'
                                                                                               class='optionInpText'
                                                                                               style="${item.isNote eq 1 ? '':'display: none;'}"/>
                                                                                        <div class="quItemInputCase">
                                                                                            <input type="hidden"
                                                                                                   name="quItemId"
                                                                                                   value="${en.quCheckboxs[quOptionIndex].id }"><input
                                                                                                type="hidden"
                                                                                                name="quItemSaveTag"
                                                                                                value="1">
                                                                                            <input type="hidden"
                                ...
                                <c:when test="${en.quType eq 'FILLBLANK' }">
                                    <div class="surveyQuItemBody">
                                        ...
                                        <div class="quInputCase" style="display: none;">
                                            ...
                                            <input type="hidden" name="answerInputWidth"
                                                   value="${en.answerInputWidth }">
                                                            ...
                                                            <div class="quFillblankItem">
                                                                <c:choose>
                                                                    <c:when test="${en.answerInputRow > 1 }">
                                                                        <input type="text"
                                                                               style="width:${empty(en.answerInputWidth)?'300':en.answerInputWidth}px;padding:5px;display: none;"
                                                                               class="quFillblankAnswerInput">
                                                                        <textarea rows="${en.answerInputRow }"
                                                                                  style="width:${empty(en.answerInputWidth)?'300':en.answerInputWidth}px;"
                                                                                  class="quFillblankAnswerTextarea"></textarea>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <input type="text"
                                                                               style="width:${empty(en.answerInputWidth)?'300':en.answerInputWidth}px;padding:5px;"
                                                                               class="quFillblankAnswerInput">
                                                                        <textarea
                                                                                rows="${empty(en.answerInputRow)?'1':en.answerInputRow }"
                                                                                style="width:${empty(en.answerInputWidth)?'300':en.answerInputWidth}px;display: none;"
                                                                                class="quFillblankAnswerTextarea"></textarea>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                                <div class="dwFbMenuBtn"></div>
...
<table class="modelHtml">
    <tr id="quScoreItemModel" class="quScoreOptionTr">
        <td class="quCoItemTableTd quOptionEditTd">
            ...
            <div class="quItemInputCase"><input type="hidden" name="quItemId" value=""><input type="hidden"
                                                                                              name="quItemSaveTag"
                                                                                              value="0"></div>
        </td>
...
<div id="quOrderItemLeftModel" class="modelHtml">
    ...
    <div class="quItemInputCase"><input type="hidden" name="quItemId" value=""><input type="hidden" name="quItemSaveTag"
                                                                                      value="0"></div>
</div>
<table class="modelHtml">
...
<table id="setQuLogicItem" style="display: none;">
    <tr id="setQuLogicItemTrModel">
        ...
        <td>则&nbsp;<select name="option_id" class="logicType" style="width: 60px;">
...
<div id="dwCommonEditRoot">
    <div class="dwCommonEdit">
        <ul class="dwComEditMenuUl">
            ...
            <li class="option_Set_Li"><a href="javascript:;" class="option_Set"><i class="menu_edit4_icon"></i>选项设置</a>
            </li>
...
<div id="dwCommonDialog">
    <form action="#" id="dwCommonDialogForm">
        ...
        <div class="dwCommonDialogBody">
            <div class="dwCommonDialogTitle"><span id="dwComDialogTitleText">标题文本</span><span id="dwCommonDialogClose"
                                                                                              class="closeDialog"></span>
            </div>
            <div class="dwCommonDialogContent">
                ...
                <div class="dwQuSetCon dwQuFormSetDialog dwQuDialogCon">
                    <ul>
                        ...
                        <li class="optionAutoOrder" style="display: none;"><label><input type="checkbox"
                                                                                         name="setRandOrder">选择随机排列</label>
                        </li>
                        <li class="contactsAttrLi" style="display: none;"><label><input type="checkbox"
                                                                                        name="setAutoContacts">关联到联系人属性</label>
                        </li>
                        ...
                        <li class="optionRangeHv"><label>选项排放：</label>
                            ...
                            <span class="option_range_3" style="display:none;"><input type="text" name="setCellCount"
                                                                                      size="2" value="3" class="">&nbsp;列</span>
                        </li>
                        ...
                        <li class="minMaxLi">
                            <span class="minSpan"><label class="lgleftLabel">&nbsp;最低分</label>&nbsp;<input
                                    class="minNum" value="1" type="text" size="2">&nbsp; <label
                                    class="lgRightLabel">分</label></span>&nbsp;&nbsp;
                            <span class="maxSpan"><label class="lgLeftLabel">最高分</label>&nbsp;<input class="maxNum"
                                                                                                     value="5"
                                                                                                     type="text"
                                                                                                     size="2">&nbsp;<label
                                    class="lgRightLabel">分</label> </span>
                    ...
                    <div class="dwQuDialogBtnCon"><input type="button" value="保存" class="quDialogBtn"
                                                         id="dwDialogQuSetSave"/></div>
                </div>
...
<div id="modelUIDialog">
    ...
    <div id="modelUIDialogContent">
        ...
        <div class="dwQuFillDataTypeOption dwQuFormSetDialog dwQuDialogCon">
            ...
            <div class="dwQuDialogBtnCon"><input type="button" value="保存" class="quDialogBtn"
                                                 id="dwDialogQuFillOptionSave"/></div>
        </div>
        ...
        <div class="dwQuRadioCheckboxOption dwQuFormSetDialog dwQuDialogCon">
            ...
            <div class="dwQuDialogBtnCon"><input type="button" value="保存" class="quDialogBtn"
                                                 id="dwDialogQuOptionSetSave"/></div>
        </div>
            ...
            <div class="tabbarDialog_1">
                <div class="p_DialogContent">
                    ...
                    <div class="p_DialogContentRoot">
                        <div class="p_DialogContentItem"><label><input type="checkbox" name="effective" value="4">
                            每台电脑或手机只能答一次</label></div>
                        <div class="p_DialogContentItem"><label><input type="checkbox" name="effectiveIp" value="1">
                            每个IP只能答一次</label></div>
                        <div class="p_DialogContentItem"><label><input type="checkbox" name="rule" value="3">
                            启用访问密码</label>
                            &nbsp;&nbsp;&nbsp;设置密码：<input type="text" size="10" name="ruleCode" class="inputSytle_1">
                        </div>
                        <div class="p_DialogContentItem"><label><input type="checkbox" name="refresh" value="1">
                            有重复回答启用验证码</label></div>
                        <div class="p_DialogContentItem" style="display: none;"><label><input type="checkbox"
                                                                                              name="mailOnly" value="1">
                            只有邮件邀请唯一链接的受访者可回答</label></div>
                    </div>
                </div>
                <div class="p_DialogContent">
                    <div class="p_DialogContentTitle">何时结束</div>
                    <div class="p_DialogContentRoot">
                        <div class="p_DialogContentItem"><label><input type="checkbox" name="ynEndNum" value="1"> 收集到&nbsp;<input
                                type="text" size="12" class="inputSytle_1" name="endNum">&nbsp;份答卷时结束</label></div>
                        <div class="p_DialogContentItem"><label><input type="checkbox" name="ynEndTime" value="1"> 到&nbsp;<input
                                type="text" size="20" class="inputSytle_1 Wdate"
                                onfocus="WdatePicker({minDate:'%y-%M-{%d+1}',dateFmt:'yyyy-MM-dd HH:mm:ss'})"
                                name="endTime">&nbsp;时结束 </label></div>
                    </div>
                </div>

            </div>
            <div class="dwQuDialogBtnCon"><input type="button" value="保存" class="quDialogBtn"
                                                 id="dwDialogSurveyAttrSave"/></div>
        </div>
