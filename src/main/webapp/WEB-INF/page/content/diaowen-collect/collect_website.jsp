...
<input type="hidden" id="surveyState" name="surveyState" value="${survey.surveyState }">
	...
	<div id="compStyle1" style="display: none;">
		<!-- DIAOWEN.NET Button BEGIN -->
		<div style="position: fixed;right: 0px;top: 100px;z-index: 9999;">
			<a href="{{host}}/wenjuan/${survey.sid }.html"
				style="background: #1C658B;width: 15px;height: 100px;background: #8CBCD1;display: block;padding: 5px;padding-top: 10px;font-weight: bold;color: white! important;cursor: pointer;float: right;vertical-align: middle;text-decoration: none;font-size: 12px;-moz-border-radius-topleft: 5px; -webkit-border-top-left-radius: 5px;-khtml-border-top-left-radius: 5px;border-top-left-radius: 5px;-moz-border-radius-bottomleft: 5px; -webkit-border-bottom-left-radius: 5px;-khtml-border-bottom-left-radius: 5px; border-bottom-left-radius: 5px;">问卷调查</a>
		</div><!-- DIAOWEN.NET Button END -->
	</div>

	<div id="priviewContent" class="priviewContentFixed">
		<div id="webSiteLeftCode">
			<div id="webSiteFixedLeft" class="websiteFixed"
				 style="position: fixed;left: 0px;top: 520px;z-index: 9999;display: none;">
				<a class="websiteAId" href="{{host}}/wenjuan/${survey.sid }.html"
		...
		<div id="webSiteRightCode">
			<div id="webSiteFixedRight" class="websiteFixed"
				 style="position: fixed;right: 0px;top: 520px;z-index: 9999;">
				<a class="websiteAId" href="{{host}}/wenjuan/${survey.sid }.html"
...
function updateCode(){
	...
	$("#compCodeText").text("<!-- Button BEGIN -->"+copyCode.replace("{{host}}", window.location.protocol + '//' + window.location.host)+"<!-- Button END -->");
}
updateCode();
