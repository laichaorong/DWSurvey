...
<title>专业的问卷表单系统</title>
<meta name="description" content="专业的调研系统" />
	...
	<div id="dwBody" >
		<div id="dwBodyContent" class="bodyCenter" style="background: none;">
					...
					<div class="dw_login_logo">
						<h1 class="f1"></h1>
						<h2 class="f2" style="width: 460px;">方便<span class="f3">、</span>高效<span class="f3">、</span>实用的调研问卷系统</h2>
					</div>
						   ...
						   <c:choose>
							...
							<div class="dlcLeft" style="border: none;">
								...
								<div class="frmItem" style="display: none;padding: 3px 5px;padding-bottom: 7px;">
									...
									<label class="frmItemLabel" ><input id="agree" name="agree" type="checkbox" checked="checked">我同意并遵守<a href="#" target="_blank">《调研问卷系统服务协议》</a></label>
								</div>
