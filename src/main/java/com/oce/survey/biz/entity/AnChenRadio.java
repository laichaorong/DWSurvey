...
import com.oce.survey.common.base.entity.IdEntity;
...
public class AnChenRadio extends IdEntity {
			//所属问卷ID
			...
			public AnChenRadio(String surveyId, String surveyAnswerId, String quId,String quRowId,String quColId) {
